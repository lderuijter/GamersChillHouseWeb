          ...
          <div class="scrollable-div max-h-full overflow-y-auto pb-28">
            ...
            <div class="bg-blue-900 shadow-lg shadow-blue-500/50 rounded-lg mb-10">
              <div class="text-center text-white font-mono h-fit text-wrap">
                ...
                <p class="text-lg">
                  ...
                  aliquet porta. Quisque ut luctus sapien. Aliquam posuere hendrerit faucibus. Lorem
                  ipsum dolor sit amet, consectetur adipiscing elit. Donec quis justo vitae magna
                  dignissim ornare. Fusce sagittis ornare nisl, et accumsan magna pretium ut. Sed
                  consequat nunc sed suscipit tincidunt. Donec egestas placerat magna, sed auctor
                  est euismod id.
                </p>
              </div>
            </div>
            <div class="bg-blue-900 shadow-lg shadow-blue-500/50 rounded-lg mb-10">
              <div class="text-center text-white font-mono h-fit text-wrap">
                ...
                <h1 class="text-2xl">Message sample</h1>
                <p class="text-lg">
                  Nullam suscipit non metus vel rhoncus. Ut porttitor, felis sit amet euismod
                  gravida, tellus arcu vehicula nunc, eget rhoncus massa velit ac nisi. Proin eu
                  sollicitudin dui. Donec aliquet quam ac felis sagittis convallis. Vivamus
                  dignissim pellentesque elit at tristique. Vestibulum convallis tortor vel enim
                  sodales blandit. Nam eu lectus sit amet urna congue sagittis. Phasellus nulla
                  diam, blandit eu est vitae, porta scelerisque lectus. Integer mollis euismod quam
                  eu commodo.
                </p>
              </div>
            </div>
